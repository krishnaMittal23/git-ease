  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <div className="bg-gray-800 rounded-xl p-5 border border-gray-700 hover:border-gray-600 hover:shadow-md transition-all col-span-2 cursor-pointer">
          <h3 className="text-lg font-semibold text-white mb-2">
            Ask a Question
          </h3>
          <p className="text-gray-400 text-sm">
            Get help with your project from teammates
          </p>
        </div>
